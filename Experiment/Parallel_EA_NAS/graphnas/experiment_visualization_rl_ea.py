...
if __name__=="__main__":
   ...
   name = ["controler_train.txt", "controler_search.txt",
           "evolution_train_RL_none_age.txt", "Citeseer_random_none_none_age.txt",
           "evolution_train_RL_age.txt", "Citeseer_wheel_1_0.2_noneage.txt",
           "random_Citeseer_random_none_none_age.txt"]

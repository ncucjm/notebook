...
if __name__=="__main__":
   ...
   name = ["", "random_Pubmed_random_0.5_0.5_random.txt",
           "random_Pubmed_wheel_0.2_0.2_wheel.txt",
           "random_Pubmed_wheel_reverse_0.8_0.8_wheel_reverse.txt",
           "Pubmed_random_0.5_0.5_random.txt",
           "Pubmed_wheel_0.2_0.2_wheel.txt",
           "Pubmed_wheel_reverse_0.8_0.8_wheel_reverse.txt"]
   #
   # name = ["", "random_Cora_random_0.5_0.5_random.txt",
   #         "random_Cora_wheel_0.2_0.2_wheel.txt",
   #         "random_Cora_wheel_reverse_0.8_0.8_wheel_reverse.txt",
   #         "Cora_random_0.5_0.5_random.txt",
   #         "Cora_wheel_0.2_0.2_wheel.txt",
   #         "Cora_wheel_reverse_0.8_0.8_wheel_reverse.txt"]

   # name = ["", "random_Citeseer_random_0.5_0.5_random.txt",
   #         "random_Citeseer_wheel_0.2_0.2_wheel.txt",
   #         "random_Citeseer_wheel_reverse_0.8_0.8_wheel_reverse.txt",
   #         "Citeseer_random_0.5_0.5_random.txt",
   #         "Citeseer_wheel_0.2_0.2_wheel.txt",
   #         "Citeseer_wheel_reverse_0.8_0.8_wheel_reverse.txt"]
  ...
  # x_e_1 = [i for i in range(len(x_e_1))]
   ...
   plt.plot(x_e_3, y_e_3, 'ro-', label='evolution_ev2_0.8')
